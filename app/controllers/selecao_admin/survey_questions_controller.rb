    ...
    def create
      ...
      respond_to do |format|
        if @survey_question.save
          format.html { redirect_to @survey_question, :notice => t('selecao_admin.flash_messages.successfully_created', :model => @survey_question.class.model_name.human) }
    ...
    def update
      ...
      respond_to do |format|
        if @survey_question.update_attributes(params[:survey_question])
          format.html { redirect_to @survey_question, :notice => t('selecao_admin.flash_messages.successfully_updated', :model => @survey_question.class.model_name.human) }
