  ...
  class SurveyQuestionsControllerTest < ActionController::TestCase
    ...
    test "should create survey_question" do
      assert_difference('SurveyQuestion.count') do
        post :create, :survey_question => { :number_of_options => @survey_question.number_of_options, :question => @survey_question.question }
      end
    ...
    test "should update survey_question" do
      put :update, :id => @survey_question, :survey_question => { :number_of_options => @survey_question.number_of_options, :question => @survey_question.question }
      assert_redirected_to survey_question_path(assigns(:survey_question))
    end
