  ...
  class DrawingsControllerTest < ActionController::TestCase
    ...
    test "should create drawing" do
      assert_difference('Drawing.count') do
        post :create, :drawing => { :publication_date => @drawing.publication_date, :publication_time => @drawing.publication_time }
      end
    ...
    test "should update drawing" do
      put :update, :id => @drawing, :drawing => { :publication_date => @drawing.publication_date, :publication_time => @drawing.publication_time }
      assert_redirected_to drawing_path(assigns(:drawing))
    end
