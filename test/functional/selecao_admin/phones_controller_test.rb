  ...
  class PhonesControllerTest < ActionController::TestCase
    ...
    test "should create phone" do
      assert_difference('Phone.count') do
        post :create, :phone => { :prefix => @phone.prefix, :resource_id => @phone.resource_id, :resource_type => @phone.resource_type, :suffix => @phone.suffix }
      end
    ...
    test "should update phone" do
      put :update, :id => @phone, :phone => { :prefix => @phone.prefix, :resource_id => @phone.resource_id, :resource_type => @phone.resource_type, :suffix => @phone.suffix }
      assert_redirected_to phone_path(assigns(:phone))
    end
