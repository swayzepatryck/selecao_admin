...
ActiveRecord::Schema.define(:version => 20130122214512) do
  ...
  create_table "integra_news_categories", :force => true do |t|
    t.string   "description"
    t.datetime "created_at",  :null => false
    t.datetime "updated_at",  :null => false
  end

  create_table "integra_news_messages", :force => true do |t|
  ...
  create_table "selecao_admin_lecture_announcements", :force => true do |t|
  ...
  add_index "selecao_admin_lecture_announcements", ["announcement_id"], :name => "index_selecao_admin_lecture_announcements_on_announcement_id"
  add_index "selecao_admin_lecture_announcements", ["lecture_id"], :name => "index_selecao_admin_lecture_announcements_on_lecture_id"
